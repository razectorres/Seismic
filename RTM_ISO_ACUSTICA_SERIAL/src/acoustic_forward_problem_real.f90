subroutine acoustic_forward_problem_real(P1,P2,P3,A,C,fonte,Gs,Gi,Ge,Gd,&
           shot_loop,sis,vel)	
  use parameters  
  implicit none
  !***********************************************************************
  ...
  !**Dados observado******************************************************
  !*********************************************************************** 
  real,dimension (Nrec,Ntotal),intent(inout)    :: Sis   
  ...
  do n = 1, Ntotal						
    ...
    !***********************************************************************
   	if (n.le.Nf2) then
	   P2(pti,ptj) = P2(pti,ptj) + fonte(n)*((vel(pti,ptj)*dt)**2)     
	  endif
    !***********************************************************************
    !***********Equacao da Onda*********************************************
    !***********************************************************************					
  ...
  !***********************************************************************
  !********Gravacao dos sismogramas***************************************
  !***********************************************************************			  
  open(39,file="./outputs/sis.bin",status='unknown',&
  & form='unformatted',access='direct',recl=4*Nrec*Ntotal)
  write(39,rec=p)((sis(i,k),k=1,Ntotal),i=1,Nrec)
  close(39)
		
end subroutine acoustic_forward_problem_real
